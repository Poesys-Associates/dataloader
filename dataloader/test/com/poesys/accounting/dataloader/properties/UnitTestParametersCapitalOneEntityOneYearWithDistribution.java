  ...
  public Reader getAccountReader(Integer year) {
    String input =
      CHECKING_ACCOUNT + DELIM + CHECKING_ACCOUNT_NAME + DELIM + CREDIT
          ...
          + CREDIT_ACCOUNT_NAME + DELIM + CREDIT + LINE_RET + CAP_ACCOUNT
          + DELIM + CAP_ACCOUNT_NAME + DELIM + CREDIT + LINE_RET + DIST_ACCOUNT
          + DELIM + DIST_ACCOUNT_NAME + DELIM + CREDIT + LINE_RET
