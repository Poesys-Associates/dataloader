  ...
  public Reader getTransactionReader(Integer year) {
    ...
    if (year.equals(START_YEAR)) {
      ...
      input =
            ...
            + EXPENSE_TRANS_ID + DELIM + EXPENSE_DESC + DELIM + TRANS_DATE_1 + DELIM + FALSE;
      // @formatter:on
      ...
      input =
            ...
            + EXPENSE_TRANS_ID + DELIM + EXPENSE_DESC + DELIM + TRANS_DATE_2 + DELIM + FALSE;
      // @formatter:on
    }
    return new StringReader(input);
  }
  ...
  public Reader getItemReader(Integer year) {
    ...
    if (year.equals(START_YEAR)) {
      ...
      input =
            ...
            + EXPENSE_TRANS_ID + DELIM + CREDIT_ACCOUNT + DELIM + EXPENSE_AMOUNT_1 + DELIM + CREDIT + DELIM + FALSE;
      // @formatter:on
    } else if (year.equals(END_YEAR)) {
      // Income: debit checking, credit revenue
      // Expense: debit tax expense, credit credit card
      ...
      input =
        ...
        + EXPENSE_TRANS_ID + DELIM + CREDIT_ACCOUNT + DELIM + EXPENSE_AMOUNT_2 + DELIM + CREDIT + DELIM + FALSE;
      // @formatter:on
    }
    return new StringReader(input);
  }
