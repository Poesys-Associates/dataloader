 ...
 * calls. This particular version returns a null start year.
 *
 * @author Robert J. Muller
 */
public class UnitTestParametersInvalidNullStartYear extends AbstractStatementMaintainingParameters {
  ...
  private static final Integer START_YEAR = null;
  ...
  public Reader getCapitalEntityReader() {
    String input = SINGLE_ENTITY_NAME + DELIM + CAP_ACCOUNT + DELIM + DELIM + OWNERSHIP.toString();
