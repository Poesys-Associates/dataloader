...
/**
 * A data transfer object that holds raw data for a reimbursement item; used to construct the old
 * accounting reimbursement item object and to link up to receivables; the amounts are positive,
 * representing credits to the receivables account. Fields: reimbursement transaction id, receivable
 * year, receivable transaction id, receivable account #, reimbursed amount, allocated amount
 *
...
public class Reimbursement extends AbstractReaderDto {
   ...
   * @param receivableTransactionId    the unique receivable transaction id within year
   * @param reimbursementYear          the fiscal year of the reimbursement
   * @param reimbursementTransactionId the unique reimbursement transaction id within year
   ...
   */
  public Reimbursement(Float accountNumber, Integer receivableYear, Integer
    receivableTransactionId, Integer reimbursementYear, Integer reimbursementTransactionId,
                       Double reimbursedAmount, Double allocatedAmount) {
    if (accountNumber == null || receivableYear == null || receivableTransactionId == null ||
        reimbursementYear == null || reimbursementTransactionId == null ||
  ...
  public int hashCode() {
    ...
    int result = 1;
    result = prime * result +
             ((reimbursementTransactionId == null) ? 0 : reimbursementTransactionId.hashCode());
    result = prime * result + ((reimbursementYear == null) ? 0 : reimbursementYear.hashCode());
    return result;
  }
  ...
  public String toString() {
    return "Reimbursement [accountNumber=" + accountNumber + ", receivableYear=" + receivableYear +
           ", receivableTransactionId=" + receivableTransactionId + ", reimbursementYear=" +
           reimbursementYear + ", reimbursementTransactionId=" + reimbursementTransactionId +
